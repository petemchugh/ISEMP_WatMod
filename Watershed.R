...
# Updated August 2013
# with Pete McHugh's John Day May 2015 tweaks
# this is the version that will start being
# mirrored on BitBucket from here (22 June) forward...
...
#getwd()#"C:/Users/Peter/Documents/Software/ISEMP_LifeCycleModelCode/S (AMIP Oct 2015)")
setwd("C:/Users/etal/Desktop/Pedro/base (ave ms S)")## Load Required Libraries
...
# Load R-Scripts in Different Files
  ...
  source("Watershed_PeteOutputs.r") #Only use this if you're interested; it's for 1 pop and hasn't been vetted for Chinook
...
for (r in 1:header$R) {
  ...
  #Pass a bunch of stuff to get summarized by CreatePeteOut -- Pete July 2015 Addition
  #Comment the next two lines out if you don't want this...
	outstuff<-CreatePeteOut(r,results,header,parameters,outstuff)

  } # End of Loop through MC Iteration
################################################################


WritePeteOut(outstuff) #Pete July 2015 Addition -- Comment out if you don't want this
